      ...
      try {
        ...
        switch (action) {
          case edgeEnum.actionType.create:
            message = converter.convertWholeConfigCreate(action, this._options.nodeId, edgeConfig, this._options.heartbeat);
            break;
        ...
        console.log("topic: " , this._mqttTopic._configTopic);
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        if (this._client.connected === false) {
          ...
          console.log(this._mqttTopic._dataTopic);
