...
class EdgeAgent {
  constructor (options) {
    ...
    this._mqttTopic = {
      ...
      _configTopic: `iot-2/evt/wacfg/fmt/${options.nodeId}`,
      _dataTopic: `iot-2/evt/wadata/fmt/${options.nodeId}`,
      _nodeConnTopic: `iot-2/evt/waconn/fmt/${options.nodeId}`,
      ...
      _cmdTopic: `iot-2/evt/wacmd/fmt/${options.nodeId}`
    };
