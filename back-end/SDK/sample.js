...
const options = {
  ...
  MQTT: {
    ...
    port: 1883,
    username: 'Goy2waYPAGQP:OxqkLYnPW7yX',
    password: '7qCdBf2LkDCboAuNxfD4',
    protocolType: edgeSDK.constant.protocol.TCP
  },
  useSecure: false,
  autoReconnect: true,
  reconnectInterval: 1000,
  scadaId: 'scada_bXdqkpu9Ds5y', // getting from datahub portal
  nodeId: 'scada_bXdqkpu9Ds5y', // getting from datahub portal
  type: edgeSDK.constant.edgeType.Gateway, // Choice your edge is Gateway or Device, Default is Gateway
  // deviceId: 'Device222222', // If type is Device, DeviceId must be filled
...
const deviceCount = 1;
const analogTagNum = 1
const discreteTagNum = 1;
const textTagNum = 1;
const arrayTagNum = 1;
const arrayTagSize = 5;
...
edgeAgent.events.on('disconnected', (error, result) => {
  console.log(error);
  console.log(result);
